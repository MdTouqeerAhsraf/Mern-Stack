...
let firstName = new String("touqeer");
...
console.log(firstName.includes("tou"));
console.log(firstName.startsWith("tou"));
console.log(firstName.endsWith("tou"));
console.log(firstName[0]);
let anotherName = firstName.replace("Touqeer", "Ashra") + "f";
...
arr.push(10);
arr.unshift(0);
arr.splice(4, 0, "Touqeer"); //index numberOfDeletedElements ValueInserted
...
let course = courses.find(function(course) {
    return course.NAme === "Touqeer";
});

console.log(course);

course = courses.find(function(course) {
    return course.NAme === "ashraf";
});

console.log(course);

course = courses.find(course => course.NAme === "Touqeer");
console.log(course);
